...
`
const HelpButton = styled(Flex).attrs({
  background: "primary",
  round: { side: "left", size: 1 },
  padding: [2, 1],
  width: "28px",
  height: "111px",
  column: true,
...
const Label = styled(Text).attrs({ color: "bright" })`
...
const Anchor = styled(Text).attrs({ as: "a", color: "primary" })`
        ...
        >
          <Container data-testid="documentation-layer">
            ...
            >
              <Text>
                Or{" "}
                <Anchor href={otherIssuesUrl} target="_blank">
                  click here
                </Anchor>{" "}
